...
define(["require", "exports", "@syncfusion/ej2-base", "@syncfusion/ej2-base", "@syncfusion/ej2-base", "@syncfusion/ej2-base", "@syncfusion/ej2-popups", "@syncfusion/ej2-inputs", "../common/incremental-search", "../drop-down-base/drop-down-base", "@syncfusion/ej2-data"], function (require, exports, ej2_base_1, ej2_base_2, ej2_base_3, ej2_base_4, ej2_popups_1, ej2_inputs_1, incremental_search_1, drop_down_base_1, ej2_data_1) {
    ...
    var DropDownList = (function (_super) {
        ...
        DropDownList.prototype.clear = function (e, property, maintainVal) {
            this.resetSelection(maintainVal);
        ...
        DropDownList.prototype.resetSelection = function (maintainVal) {
            if (this.list) {
        ...
        DropDownList.prototype.getItemData = function () {
            ...
            var dataValue;
            var dataText;
            if (!ej2_base_2.isNullOrUndefined(dataItem)) {
                dataValue = ej2_base_2.getValue(fields.value, dataItem);
                dataText = ej2_base_2.getValue(fields.text, dataItem);
            }
            var value = (!ej2_base_2.isNullOrUndefined(dataItem) &&
                !ej2_base_2.isUndefined(dataValue) ? dataValue : dataItem);
            var text = (!ej2_base_2.isNullOrUndefined(dataItem) &&
                !ej2_base_2.isUndefined(dataValue) ? dataText : dataItem);
        ...
        DropDownList.prototype.searchLists = function (e) {
            ...
            if (this.isFiltering()) {
                ...
                if (!this.isCustomFilter && !eventArgs_1.preventDefaultAction) {
                    var filterQuery = this.query ? this.query.clone() : new ej2_data_1.Query();
                    ...
                    if (!(this.dataSource instanceof ej2_data_1.DataManager) && dataType === 'string' || dataType === 'number') {
                        ...
                        var fields = this.fields;
                        filterQuery.where(!ej2_base_2.isNullOrUndefined(fields.text) ? fields.text : '', 'startswith', this.filterInput.value, true, this.ignoreAccent);
                    }
        ...
        DropDownList.prototype.filteringAction = function (dataSource, query, fields) {
            if (!ej2_base_2.isNullOrUndefined(this.filterInput)) {
                ...
                if (this.filterInput.value.trim() === '') {
                    ...
                    this.isTyped = true;
                    if (!ej2_base_2.isNullOrUndefined(this.itemData) && this.getModuleName() === 'dropdownlist') {
                        this.focusIndexItem();
                        this.setScrollPosition();
                    }
            ...
            if (!ej2_base_2.isNullOrUndefined(this.itemData) && !ej2_base_2.isNullOrUndefined(newElement)) {
                ...
                var isExist = listData.some(function (data) {
                    return (((typeof data === 'string' || typeof data === 'number') && data === value_1) ||
                        (ej2_base_2.getValue(_this.fields.value, data) === value_1));
                });
                if (!isExist) {
        ...
        DropDownList.prototype.createPopup = function (element, offsetValue, left) {
            ...
            this.popupObj = new ej2_popups_1.Popup(element, {
                ...
                open: function () {
                    ej2_base_1.EventHandler.add(document, 'mousedown', _this.onDocumentClick, _this);
        ...
        DropDownList.prototype.scrollHandler = function () {
            ...
            if (this.fields.groupBy && !ej2_base_2.isNullOrUndefined(this.fixedHeaderElement)) {
        ...
        DropDownList.prototype.render = function () {
            ...
            this.hiddenElement = ej2_base_1.createElement('select', {
                attrs: { 'name': name, 'aria-hidden': 'true', 'tabindex': '-1', 'class': exports.dropDownListClasses.hiddenElement }
            });
            ...
            for (var _i = 0, _a = Object.keys(newProp); _i < _a.length; _i++) {
                ...
                switch (prop) {
                    ...
                    case 'showClearButton':
                        ej2_inputs_1.Input.setClearButton(newProp.showClearButton, this.inputElement, this.inputWrapper);
                        this.bindClearEvent();
                        break;
                    default:
                        var ddlProps = void 0;
