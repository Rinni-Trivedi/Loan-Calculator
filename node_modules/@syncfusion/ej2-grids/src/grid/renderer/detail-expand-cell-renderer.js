...
define(["require", "exports", "@syncfusion/ej2-base", "./cell-renderer"], function (require, exports, ej2_base_1, cell_renderer_1) {
    ...
    var DetailExpandCellRenderer = (function (_super) {
        ...
        DetailExpandCellRenderer.prototype.render = function (cell, data, attributes) {
            ...
            if (attributes && !ej2_base_1.isNullOrUndefined(attributes['class'])) {
                node.className = '';
                node.className = attributes['class'];
                node.appendChild(ej2_base_1.createElement('div', { className: 'e-icons e-dtdiagonaldown e-icon-gdownarrow' }));
            }
            else {
