...
define(["require", "exports", "@syncfusion/ej2-base", "@syncfusion/ej2-base", "../base/enum", "../base/constant"], function (require, exports, ej2_base_1, ej2_base_2, enum_1, event) {
        ...
        HeaderFocus.prototype.onClick = function (e) {
            ...
            if (!target && this.parent.frozenRows !== 0) {
                target = (e.target.classList.contains('e-rowcell') ? e.target :
                    ej2_base_1.closest(e.target, 'td'));
            }
            if (!target) {
                return;
            }
    ...
    exports.FixedContentFocus = FixedContentFocus;
    ...
    exports.FixedHeaderFocus = FixedHeaderFocus;
    var SearchBox = (function () {
        ...
        SearchBox.prototype.wireEvent = function () {
            if (this.searchBox) {
                ej2_base_1.EventHandler.add(this.searchBox, 'focus', this.searchFocus, this);
                ej2_base_1.EventHandler.add(this.searchBox, 'blur', this.searchBlur, this);
            }
        };
        SearchBox.prototype.unWireEvent = function () {
            if (this.searchBox) {
                ej2_base_1.EventHandler.remove(this.searchBox, 'focus', this.searchFocus);
                ej2_base_1.EventHandler.remove(this.searchBox, 'blur', this.searchBlur);
            }
        };
        return SearchBox;
    }());
