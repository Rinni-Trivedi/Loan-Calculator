            ...
            if (isSelector) {
                ...
                if (res && res.length) {
                    ...
                    promise.then(function () {
                        ...
                        var result = args[0];
                        var pResult = _this.adaptor.processResponse(result[0], _this, query, ajax.httpRequest, ajax);
                        var count = 0;
                        if (query.isCountRequired) {
                            count = pResult.count;
                            pResult = pResult.result;
                        }
                        var cResult = _this.adaptor.processResponse(result[1], _this, query.subQuery, ajax.httpRequest, ajax);
                        count = 0;
                        ...
                        isSelector = false;
                        process(pResult, count, ajax.httpRequest);
                    });
                }
                else {
                    isSelector = false;
