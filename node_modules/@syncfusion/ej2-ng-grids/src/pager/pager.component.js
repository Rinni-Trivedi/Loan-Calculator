...
export var inputs = ['currentPage', 'customText', 'enableExternalMessage', 'enablePagerMessage', 'enablePersistence', 'enableQueryString', 'enableRtl', 'externalMessage', 'locale', 'pageCount', 'pageSize', 'pageSizes', 'template', 'totalRecordsCount'];
export var outputs = ['click', 'created', 'dropDownChanged'];
export var twoWays = [];
/**
...
var PagerComponent = /** @class */ (function (_super) {
    ...
    function PagerComponent(ngEle, viewContainerRef) {
