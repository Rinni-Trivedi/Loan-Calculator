    ...
    var TimePicker = (function (_super) {
        ...
        TimePicker.prototype.preRender = function () {
            ...
            if (this.element.tagName === 'EJS-TIMEPICKER') {
                ...
                this.inputElement = ej2_base_4.createElement('input');
        ...
        TimePicker.prototype.initialize = function () {
            ...
            if (!ej2_base_5.isNullOrUndefined(this.element.getAttribute('id'))) {
                if (this.angularTag !== null) {
                    this.inputElement.id = this.element.getAttribute('id') + '_input';
                }
            }
            else {
                this.element.id = ej2_base_5.getUniqueID('ej2_timepicker');
                if (this.angularTag !== null) {
                    ej2_base_4.attributes(this.inputElement, { 'id': this.element.id + '_input' });
                }
            }
            if (ej2_base_5.isNullOrUndefined(this.inputElement.getAttribute('name'))) {
                ej2_base_4.attributes(this.inputElement, { 'name': this.element.id });
            }
        };
        ...
        TimePicker.prototype.destroy = function () {
            ...
            if (this.inputElement) {
                ...
                if (ej2_base_5.isNullOrUndefined(this.cloneElement.getAttribute('disabled'))) {
                    ej2_inputs_1.Input.setEnabled(true, this.inputElement, this.floatLabelType);
                }
            }
        ...
        TimePicker.prototype.ensureInputAttribute = function () {
            for (var i = 0; i < this.inputElement.attributes.length; i++) {
                ...
                if (ej2_base_5.isNullOrUndefined(this.cloneElement.getAttribute(prop))) {
                    if (prop.toLowerCase() === 'value' || ej2_base_5.isNullOrUndefined(this.cloneElement.getAttribute('value'))) {
        ...
        TimePicker.prototype.setWidth = function (width) {
            if (typeof width === 'number') {
                width = ej2_base_5.formatUnit(width);
            }
            else if (typeof width === 'string') {
                width = (width.match(/px|%|em/)) ? width : ej2_base_5.formatUnit(width);
            }
            else {
                width = '100%';
            }
            ...
            if (!this.readonly && this.enabled) {
                ...
                switch (event.action) {
                    ...
                    case 'open':
                        ...
                        break;
                    case 'escape':
                        ej2_inputs_1.Input.setValue(this.objToString(this.value), this.inputElement, this.floatLabelType, this.showClearButton);
        ...
        TimePicker.prototype.closePopup = function (delay, e) {
            if (this.isPopupOpen() && this.popupWrapper) {
                ...
                if (!args.cancel) {
                    ...
                    ej2_base_4.removeClass([this.inputWrapper.container], [ICONANIMATION]);
        ...
        TimePicker.prototype.strictOperation = function (minimum, maximum, dateVal, val) {
            ...
            if (this.strictMode) {
                if (+minValue > +maxValue) {
                    ...
                    ej2_inputs_1.Input.setValue(this.getValue(this.initValue), this.inputElement, this.floatLabelType, this.showClearButton);
        ...
        TimePicker.prototype.unBindEvents = function () {
            ...
            ej2_base_1.EventHandler.remove(this.inputWrapper.clearButton, 'mousedown touchstart', this.clearHandler);
        };
        ...
        TimePicker.prototype.validateValue = function (date, value) {
            ...
            if (!this.strictMode && ej2_base_5.isNullOrUndefined(time)) {
                ...
                ej2_inputs_1.Input.setValue(value_1, this.inputElement, this.floatLabelType, this.showClearButton);
            }
            else {
                ej2_inputs_1.Input.setValue(time, this.inputElement, this.floatLabelType, this.showClearButton);
            }
            return time;
        };
        ...
        TimePicker.prototype.changeEvent = function (e) {
            ...
            var eventArgs = {
                ...
                isInteracted: !ej2_base_5.isNullOrUndefined(e),
        ...
        TimePicker.prototype.createListItems = function () {
            ...
            ej2_base_4.attributes(this.listTag, { 'role': 'listbox', 'aria-hidden': 'false', 'id': this.element.id + '_options' });
        ...
        TimePicker.prototype.inputBlurHandler = function (e) {
            ...
            this.closePopup(0, e);
            ej2_base_4.removeClass([this.inputWrapper.container], [FOCUS]);
            var blurArguments = {
                model: this
            };
            ...
            for (var _i = 0, _a = Object.keys(newProp); _i < _a.length; _i++) {
                ...
                switch (prop) {
                    ...
                    case 'locale':
                        ...
                        break;
                    case 'width':
                        ej2_base_4.setStyleAttribute(this.inputWrapper.container, { 'width': this.setWidth(newProp.width) });
                        this.containerStyle = this.inputWrapper.container.getBoundingClientRect();
                        break;
                    case 'format':
