define(["require", "exports", "../internationalization", "../util", "./parser-base", "./date-formatter", "./number-formatter"], function (require, exports, internationalization_1, util_1, parser_base_1, date_formatter_1, number_formatter_1) {
    "use strict";
    ...
    (function (IntlBase) {
        ...
        function getActualNumberFormat(culture, options, cldr) {
            ...
            if (curMatch) {
                ...
                var curCode = getCurrencySymbol(dependable.numericObject, options.currency || internationalization_1.defaultCurrencyCode);
