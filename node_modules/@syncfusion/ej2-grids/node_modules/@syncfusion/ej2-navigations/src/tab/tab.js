    ...
    var Tab = (function (_super) {
        ...
        Tab.prototype.removeActiveClass = function (id) {
            ...
            if (!ej2_base_4.isNullOrUndefined(hdrActEle)) {
                ...
                var trg = this.findEle(ej2_base_2.select('.' + CLS_CONTENT, this.element).children, CLS_CONTENT + '_' + no);
            }
        };
        ...
        Tab.prototype.getTrgContent = function (cntEle, no) {
            ...
            if (this.element.classList.contains(CLS_NEST)) {
                ele = ej2_base_2.select('.' + CLS_NEST + '> .' + CLS_CONTENT + ' > #' + CLS_CONTENT + '_' + no, this.element);
            }
            else {
        ...
        Tab.prototype.setActive = function (value) {
            ...
            if (this.isTemplate) {
                if (ej2_base_2.select('.' + CLS_CONTENT, this.element).children.length > 0) {
                    var trg_1 = this.findEle(ej2_base_2.select('.' + CLS_CONTENT, this.element).children, CLS_CONTENT + '_' + no);
        ...
        Tab.prototype.removeTab = function (index) {
            ...
            var cntTrg = this.findEle(ej2_base_2.select('.' + CLS_CONTENT, this.element).children, CLS_CONTENT + '_' + no);
